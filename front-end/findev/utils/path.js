...
export const searchUrl = "http://20.96.157.51/api/server/jobs";
export const recommendUrl = "http://20.96.157.51/api/server/recommend-job";
export const readCVUrl = "http://20.96.157.51/api/cv/read-cv";
export const relatedUrl = "http://20.96.157.51/api/server/title?title=";
